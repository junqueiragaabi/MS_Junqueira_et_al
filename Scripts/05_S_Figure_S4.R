...
fig_S4_plot_grazer <- fig_S4_plot_b + fig_S4_plot_c

fig_S4_plot_substrate <- fig_S4_plot_d + fig_S4_plot_e

fig_S4_plot_a / fig_S4_plot_grazer / fig_S4_plot_substrate

ggplot2::ggsave(here::here("Output","Figure_S4.png"),
